 ...
 * @author ANDRES MS
 */
public class AcreditariosCompañia extends javax.swing.JFrame {

    /**
     * Creates new form frame4
     */
    public AcreditariosCompañia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Ir a Debitarios Bancos");

        jLabel3.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jLabel3.setText("ACREDITARIOS COMPAÑIA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AcreditariosCompañia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AcreditariosCompañia().setVisible(true);
            }
        });
    }
