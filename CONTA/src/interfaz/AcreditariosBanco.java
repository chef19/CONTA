 ...
 * @author ANDRES MS
 */
public class AcreditariosBanco extends javax.swing.JFrame {

    /**
     * Creates new form frame3
     */
    public AcreditariosBanco() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ACREEDITARIOS BANCOS");

        jLabel1.setText("Codigo");

        jLabel2.setText("Monto");

        jButton3.setText("Ir a Debitarios Bancos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AcreditariosBanco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AcreditariosBanco().setVisible(true);
            }
        });
    }
