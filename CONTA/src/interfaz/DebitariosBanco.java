 ...
 * @author ANDRES MS
 */
public class DebitariosBanco extends javax.swing.JFrame {

    /**
     * Creates new form frame1
     */
    public DebitariosBanco() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Ir a Acreditarios Compañia");

        jLabel3.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jLabel3.setText("DEBITARIOS BANCOS");

        jButton3.setText("Ir a Acreditarios Bancos");

        jButton4.setText("Ir a Debitarios Compañia");

        jButton6.setText("SALDOS");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(CodigoTF, javax.swing.GroupLayout.DEFAULT_SIZE, 84, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        SALDOS.saldo.BancoD(CodigoTF.getText(), monto);
        SALDOS.DebBco.add(CodigoTF.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DebitariosBanco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DebitariosBanco().setVisible(true);
            }
        });
    }
