 ...
 * @author ANDRES MS
 */
public class DebitariosCompañia extends javax.swing.JFrame {

    /**
     * Creates new form frame2
     */
    public DebitariosCompañia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("DEBITARIOS COMPAÑIA");
        ...
        jButton4.setText("Ir a Debitarios Bancos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DebitariosCompañia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DebitariosCompañia().setVisible(true);
            }
        });
    }
